        ...
        <div className="max-w-5xl mx-auto">
          <div className="mb-12">
            ...
            <p className="text-xl text-muted-foreground mb-6">
              Protect digital assets and learn to defend against modern cyber threats. Master the 
              art of securing systems, networks, and data in an increasingly connected world.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <Card className="p-8 bg-card border-primary/20 neon-border">
              ...
              <p className="text-muted-foreground mb-4">
                Our Cybersecurity program trains you to become a guardian of digital infrastructure. 
                Learn offensive and defensive security techniques, compliance standards, and how to 
